...
class HaseelaService {
  ...
  Future<void> updateTaskStatus(
      String parentId, String childId, String taskId, String status) async {
    try {
  ...
  Future<void> updateTaskStatusWithImage(String parentId, String childId,
      String taskId, String status, String imagePath) async {
    try {
      Map<String, dynamic> updateData = {
        'status': status,
  ...
  Future<String> uploadTaskImage(
      String parentId, String childId, String taskId, XFile imageFile) async {
    try {
